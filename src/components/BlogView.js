        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-12">
              ...
              {/* <div className="single-blog-inner style-2">
                <div className="thumb">
                  <img src="assets/img/blog/5.png" alt="Falconl" />
                </div>
                <div className="details">
                  <ul className="blog-meta">
                    <li>
              ...
              <div className="single-blog-inner style-2">
                <div className="thumb">
                  <img src="assets/img/blog/6.png" alt="Falconl" />
                </div>
                <div className="details">
                  <ul className="blog-meta">
                    <li>
            ...
            {/* <div className="col-lg-4">
              <div className="sidebar-area">
                ...
                <div className="widget widget_author text-center">
                  <div className="thumb">
                    <img src="assets/img/blog/blog-author.png" alt="Falconl" />
                  </div>
                  <h5>Alone Mask</h5>
                  <p>
                  ...
                  <ul>
                    <li>
                      <div className="single-recent-post">
                        <div className="thumb">
                          <img src="assets/img/widget/1.png" alt="Falconl" />
                        </div>
                        <div className="details">
                          <h6>
                    ...
                    <li>
                      <div className="single-recent-post">
                        <div className="thumb">
                          <img src="assets/img/widget/2.png" alt="Falconl" />
                        </div>
                        <div className="details">
                          <h6>
                            <a href="#">Learning Transport Is Not Difficult</a>
                    ...
                    <li>
                      <div className="single-recent-post">
                        <div className="thumb">
                          <img src="assets/img/widget/3.png" alt="Falconl" />
                        </div>
                        <div className="details">
                          <h6>
                            <a href="#">Learning Transport Is Not Difficult</a>
